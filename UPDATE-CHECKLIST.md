...
- [ ] **Runtime context assets** — If the process reads bundled files outside `processes/` or `thinkers/`, add them to `pyproject.toml` wheel force-includes and `clarity-server.spec` data files
